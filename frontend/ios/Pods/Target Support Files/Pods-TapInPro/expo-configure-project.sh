...
with_node \
  ...
  --target "/Users/hodanmohamoud/orchids-projects/orchids-mobile-app/frontend/ios/Pods/Target Support Files/Pods-TapInPro/ExpoModulesProvider.swift" \
  --entitlement "/Users/hodanmohamoud/orchids-projects/orchids-mobile-app/frontend/ios/TapInPro/TapInPro.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-notifications" "expo-router" "expo-system-ui" "expo-updates"
