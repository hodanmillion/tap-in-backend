          ...
          className="flex-1">
            ...
            >
                  <View className="items-center mb-12 mt-8">
                    ...
                    <Text className="text-6xl font-black text-white tracking-tighter text-center">TapIn</Text>
                    <Text className="mt-4 text-center text-xl font-medium text-zinc-400 px-4 leading-tight">
                  ...
                  <View>
                    <View className="mb-4">
                      <Text className="text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2 ml-1">Email</Text>
                      <Input
                        ...
                        className="h-14 rounded-2xl bg-zinc-900 border-0 px-5 font-semibold text-white"
                        placeholderTextColor="#555"
                      />
                    </View>
    
                    <View className="mb-4">
                      <Text className="text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2 ml-1">Password</Text>
                      <Input
                        placeholder="••••••••"
                        value={password}
                  ...
                  <TouchableOpacity className="self-end mt-1 py-2">
                    <Text className="text-xs font-bold text-white uppercase tracking-widest opacity-60">Forgot Password?</Text>
                  </TouchableOpacity>
  
                    <TouchableOpacity
                      onPress={signInWithEmail}
                      disabled={loading}
                      className="mt-8 bg-white h-14 rounded-2xl items-center justify-center shadow-lg active:opacity-90"
                    >
                      <View className="flex-row items-center">
                        <Text className="text-base font-black text-black uppercase tracking-widest">Sign In</Text>
                        <ChevronRight size={18} color="black" strokeWidth={3} className="ml-2" />
                      </View>
                    </TouchableOpacity>
  
  
                <View className="mt-12 flex-row justify-center items-center gap-2">
                  <Text className="text-sm font-bold text-zinc-500 uppercase tracking-widest">New here?</Text>
                  <Link href="/(auth)/register" asChild>
                    <TouchableOpacity>
                      <Text className="text-sm font-black text-white uppercase tracking-widest">Create Account</Text>
                    </TouchableOpacity>
                  </Link>
                </View>
                </View>
              ...
              <Text className="text-[10px] font-black text-zinc-800 uppercase tracking-[0.3em]">
                Securim Inc. • v15.0.0
              </Text>
            </View>
          </ScrollView>
