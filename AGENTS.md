...
- **Backend**: Hono (running on Node.js/Bun), Supabase (Auth, Database, Storage), Resend (Transactional Emails), Expo Push Notifications. Hosted on Render for production.
